  ...
  return (
    ...
    <div className="container my-5">
     <div className="row justify-content-center">
      <div className="d-flex d-sm-12 col-lg-12 col-md-9 col-sm-12">
       <div className="card mision rounded mt-4 my-5 w-50 me-3 col-sm-12">
       ...
       <div className="card mision rounded mt-4 my-5 w-50 ms-3 col-sm-12">
